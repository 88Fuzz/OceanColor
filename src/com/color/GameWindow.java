...
public abstract class GameWindow extends JFrame
{
	...
	public void init()
	{
		...
		Globals.WIDTHMAP=Globals.WIDTH/Globals.SCALEFACTOR;
		Globals.HEIGHTMAP=Globals.HEIGHT/Globals.SCALEFACTOR;
		
		System.out.println("width: "+Globals.WIDTH+" height: "+Globals.HEIGHT);
		System.out.println("widthmap: "+Globals.WIDTHMAP+" heightmap "+Globals.HEIGHTMAP);
